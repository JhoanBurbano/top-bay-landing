...
const CardService: React.FC<CardServiceProps> = ({description, icon: Icon, source, title}) => {
  return (
    <article className={`relative xl:w-[400px] h-[300px] flex text-white items-center justify-center rounded-xl overflow-hidden m-auto`} style={{background: `url(${source})`, backgroundSize: 'cover'}}>
